		...
		<div class="panel panel-default">
		  ...
		  <div class="panel-body">
		      ...
		      <div class="form-group">
			    ...
			    <input type="text" class="form-control" id="sjmc" name="sjmc" value="${requestScope.sj.sjmc }">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputFile">商家图片</label>
			    <input type="file" id="sjtp" name="sjtp">
			    <p class="help-block">从这里上传您的商家图片</p>
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">服务态度</label>
			    <input type="text" class="form-control" id="fwtd" name="fwtd" value="${requestScope.sj.fwtd }">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">商品质量</label>
			    <input type="text" class="form-control" id="spzl" name="spzl" value="${requestScope.sj.spzl }">
			  </div>
