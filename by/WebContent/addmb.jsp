  ...
  <div class="container-fluid">
	...
	<div class="row">
		...
		<div class="panel panel-default">
		  <div class="panel-heading"><h4>模板添加</h4></div>
		  <div class="panel-body">
		  	<form action="addmb" class="form-group" method="POST" enctype="multipart/form-data">
		      <div class="form-group">
			    <label for="exampleInputPassword1">模板名称</label>
			    <input type="text" class="form-control" id="mbmc" placeholder="请输入您的模板名称" name="mbmc">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">模板地址</label>
			    <input type="text" class="form-control" id="mbdz" placeholder="请输入您的模板地址" name="mbdz">
			  </div>
